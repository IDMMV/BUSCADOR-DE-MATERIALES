const CACHE='buscador-materiales-v32';
const ASSETS=['./','./index.html','./data.js','./manifest.webmanifest','./favicon-16.png','./favicon-32.png','./apple-touch-icon.png','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
